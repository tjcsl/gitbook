...
Integrated authentication using LDAP and [Kerberos](../kerberos.md) was initially deployed in lab 231 during the spring of 2006. Sun Directory Server 5.2 was used at the time, replicated from sol across what are now known as [chuku](../../../machines/outdated/chuku.md) and [ekhi](../../../machines/outdated/ekhi.md). During the summer following, LDAP was moved into a VMWare virtual machine known as daystar in order to run LDAP on a faster system. However, for reasons not completely understood, the VM subsequently developed problems during the fall of 2006 and resulted in NSS becoming painfully slow on both [rockhopper](../../../machines/outdated/rockhopper.md) (at that time used for all of lab 231 and 16 LTSP nodes in the CSL) and the rest of the CSL workstations. In order to remedy the situation, `/etc/passwd` was rapidly deployed as a flatfile across all affected systems. Hesiod was subsequently set up as the NSS database for the remainder of the school year and the beginning of the next.

During the winter of 2007-08, NSS was switched back to LDAP following various discussions. (Need more information.) LDAP was configured on [chuku](../../../machines/outdated/chuku.md) and [mihr](../../../machines/outdated/mihr.md), running Sun Directory Server 6.

Upon reception of the [Sun Academic Excellence Grant](../../../machines/history/2008-sun-aeg.md), LDAP was moved into the LDOMs (UltraSPARC-specific virtual machines) ldap1 and ldap2 running on [Ohare](../../../machines/sun-servers/ohare.md) and [Logan](../../../machines/sun-servers/logan.md).
