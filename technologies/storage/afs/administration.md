...
* `bos`, the <b>B</b>asic <b>O</b>ver<b>s</b>eers, which essentially oversees every other server
* `pts`, the <b>P</b>ro<b>t</b>ection <b>S</b>erver, which keeps track of users and groups
* `vos`, the <b>Vo</b>lume <b>S</b>erver, which keeps track of volumes
* `fs`, which, as you might expect, is the <b>F</b>ile <b>S</b>erver.
