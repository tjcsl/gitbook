...
**Django** is a Python web framework designed for enterprise-scale application. [Ion](../../services/ion/README.md), [Director](../../services/director/README.md), and [Othello](../../services/othello/README.md) are all Django applications.
...
3. Add the view to the app
    ```python
    # your_project/apps/the_app/views.py
...
6. You're done! Start the server using `python manage.py runserver 8001` and go to `http://localhost:8001/randnum` to (hopefully) see your random number!
